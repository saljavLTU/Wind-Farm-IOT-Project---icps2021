...
dfile = 'T2_traineddict.mat'  #File name containing the trained dictionary
raw_data ='./Turbine2.csv'     #File name containing the raw data

#Output
destFile = 'Testingt2d2'  #File name that will contain the output
